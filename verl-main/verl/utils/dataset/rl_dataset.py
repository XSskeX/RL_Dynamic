            ...
            if processor is not None:
                ...
                def doc2len(doc) -> int:
                    try:
                        ...
                        if self.tool_schemas is not None:
                            apply_kwargs["tools"] = self.tool_schemas
                        #print("tool_schemas:", self.tool_schemas, "type:", type(self.tool_schemas))
                        #print("tools_in_kwargs:", "tools" in apply_kwargs, "tools_val:", apply_kwargs.get("tools"))
                        return len(
