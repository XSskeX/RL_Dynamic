...
def default_compute_score(
    ...
    **kwargs,
    ...
    elif data_source == "MathArena/aime_2025":
        from . import AIME2025
        res = AIME2025.compute_score(solution_str, ground_truth)
    elif data_source == "HuggingFaceH4/aime_2024":
        from . import AIME2024
        res = AIME2024.compute_score(solution_str, ground_truth)
    elif data_source == "BytedTsinghua-SIA/DAPO-Math-17k":
        from . import DAPO17k
        res = DAPO17k.compute_score(solution_str, ground_truth)
    ...
    elif data_source == "K-and-K/knights-and-knaves":
        from . import mem_kk_logic
        res = mem_kk_logic.compute_score(solution_str, ground_truth)
    elif data_source == "nvidia/Nemotron-Research-GooseReason-0.7M":
        from . import GooseResearch_stem
        res = GooseResearch_stem.compute_score(solution_str, ground_truth)
