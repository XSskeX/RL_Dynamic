...
class RayPPOTrainer:
    ...
    def _validate(self, merged: bool = False, valid_idx = 0):
        ...
        for test_data in self.val_dataloader:   
            ...
            os.makedirs(f"/share/nlp/baijun/shuhan/val_output_rollout-8/Llama3.2-3B-Instruct_Val_MMLU-Pro/{valid_idx}", exist_ok=True)
            for j in range(len(input_texts)):
                ...
                with open(f"/share/nlp/baijun/shuhan/val_output_rollout-8/Llama3.2-3B-Instruct_Val_MMLU-Pro/{valid_idx}/output_{j+1}.json", "w", encoding="utf-8") as f:
                    f.write(json.dumps(
                output_content,
                ensure_ascii=False,
                indent=2
