...
class RayPPOTrainer:
    ...
    def _validate(self, merged: bool = False, valid_idx = 0):
        ...
        for test_data in self.val_dataloader:   
            ...
            os.makedirs(f"/share/nlp/baijun/shuhan/val_output/Llama3.2-1B-Instruct_Val_test/{valid_idx}", exist_ok=True)
            for j in range(len(input_texts)):
                ...
                with open(f"/share/nlp/baijun/shuhan/val_output/Llama3.2-1B-Instruct_Val_test/{valid_idx}/output_{j+1}.json", "w", encoding="utf-8") as f:
                    f.write(json.dumps(
                output_content,
                ensure_ascii=False,
                indent=2
