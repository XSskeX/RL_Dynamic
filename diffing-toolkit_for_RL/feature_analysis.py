...
def compute_feature_norm(crosscoder):
    ...
    latent_df.to_csv(Path(f"/share/nlp/baijun/shuhan/crosscoder_output/crosscoder_output_for_8/llama32_3B_Instruct_latent_norm.csv"), encoding='utf-8-sig')
    return latent_df
...
def compute_feature_drift_cosine(crosscoder):
    ...
    latent_df.to_csv(Path(f"/share/nlp/baijun/shuhan/crosscoder_output/crosscoder_output_for_8/llama32_3B_Instruct_latent_drift.csv"), encoding='utf-8-sig')
    return latent_df
